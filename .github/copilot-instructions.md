# GitHub Copilot Instructions - CloudDocs Web UI

This document contains specific instructions for GitHub Copilot when working on the CloudDocs Web UI project. Always follow these rules and patterns.
